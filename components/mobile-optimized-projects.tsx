...
const ModernProjectCard: React.FC<{ project: Project }> = ({ project }) => {
  return (
    <div id={project.id} className="group relative flex flex-col rounded-xl border border-border/60 bg-card shadow-sm hover:shadow-xl hover:shadow-[#a6808c]/10 transition-all duration-700 ease-out-quint hover:-translate-y-2 overflow-hidden h-full will-change-transform scroll-mt-24">
      ...
      <div className="relative w-full aspect-video overflow-hidden border-b border-border/40 bg-slate-50 dark:bg-black/20 group-hover:brightness-105 transition-all duration-700">
        <div className="absolute inset-0 transition-transform duration-1000 ease-out-quint group-hover:scale-110">
