...
export const Navbar = ({ children }: { children?: React.ReactNode }) => {
  ...
  return (
    <NavbarContext.Provider value={{ isScrolled }}>
      <header
        className={cn(
          "fixed top-4 left-0 right-0 z-50 mx-auto transition-all duration-500 ease-spring-gentle",
      ...
      >
        <div 
          className={cn(
            "rounded-full border transition-all duration-700 ease-spring-gentle px-6 sm:px-8",
            isScrolled 
