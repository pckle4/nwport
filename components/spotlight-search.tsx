...
export function SpotlightSearch({ isOpen, onClose }: SpotlightSearchProps) {
  ...
  const actions: ActionItem[] = [
...

    {
      ...
      perform: () => navigateTo("/#project-resume"),
      type: "project",
    ...
    },
    {
      ...
      perform: () => navigateTo("/#project-link-share"),
      type: "project",
    ...
    },
    {
      ...
      perform: () => navigateTo("/#project-p2p"),
      type: "project",
